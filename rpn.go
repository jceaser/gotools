...
func main() {
	...
	//flag setup
	formula := flag.String("formula", "", "math formula in RPN format, interpreted before stream")
	file := flag.String("file", "", "read in from a file")

	interactive := flag.Bool("interactive", false, "interactive mode using a readline style interface")
	verbose := flag.Bool("verbose", false, "verbose")
	final_pop := flag.Bool("pop", false, "output a final pop")
